...
export function OnboardingShell({
  ...
  return (
    <main className="min-h-dvh min-w-0 overflow-x-clip bg-slate-50 text-foreground dark:bg-background">
      ...
      <div className="mx-auto min-w-0 max-w-6xl px-4 py-7 pb-28 sm:px-6 sm:py-10 sm:pb-28 lg:px-8">
        {children}
      </div>
    </main>
  );
